...
|pub fn make_move(&mut self, &str ) -> String | Moves a piece. The string is formatted as follows: "(From)(To)(Optional: Promotion Piece)". Example "E2E3", from E2 to E3 no promotion piece needed. Example PAWN "E7E8Q", from E7 to E8, promote to QUEEN. Returns a FEN string with the current board state.|
